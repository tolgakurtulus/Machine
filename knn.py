...
plt.scatter(M.radius_mean, M.texture_mean,color="blue",label="Bad")
plt.scatter(B.radius_mean, B.texture_mean,color="grey",label="Good")
plt.xlabel("Radius")
plt.ylabel("Texture")
plt.legend()
plt.show()
...
knn = KNeighborsClassifier(n_neighbors = 1)  # n_neighbors = Key value
